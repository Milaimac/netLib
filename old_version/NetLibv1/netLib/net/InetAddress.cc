...
// it just return network Endian of addr 
...
// resolve: base the hostname get the address
bool InetAddress::resolve(StringArg hostname, InetAddress* out){
    ...
    // it will depend the hostname, get the hent
    // and the t_resolveBuffer is store the all_kind information in the procedure cache.
